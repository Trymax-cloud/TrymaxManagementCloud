-- ============================================================
-- EWMP URGENT FIX - USER VISIBILITY & TASK ASSIGNMENT - ERROR FREE
...
-- Drop ALL existing assignment policies first
...
DROP FUNCTION IF EXISTS public.get_simple_users();
...
-- Drop function if exists
DROP FUNCTION IF EXISTS public.get_assignments_with_creator();
...
SELECT 
  'MESSAGE VISIBILITY TEST' as test,
...
WHERE schemaname = 'public' 
  AND tablename IN ('profiles', 'assignments', 'meetings', 'messages')
